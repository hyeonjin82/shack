(function () {
    ...
    // ui-router config
    shack.config(["$stateProvider", "$urlRouterProvider", function ($stateProvider, $urlRouterProvider, USER_ROLES) {
    ...
    shack.directive('userAvatar', function () {
        return {
            replace: true,
            ...
            // template : 'asset/images/jin_avatar.svg'
        };
    });

    shack.run(function ($rootScope, $location, $http, AuthSharedService, Session, USER_ROLES, $q, $timeout) {
